...
const ANTI_ABUSE = [
  ...
  },
  {
    ...
    desc: "Funds stay in DonationVault until milestone proof is submitted and donors approve via DAO vote.",
  },
  {
  ...
  {
    title: "One Impact NFT per campaign",
    desc: "Donors receive a single tiered badge per campaign (upgraded on further donations). This prevents spam minting while preserving proof of impact.",
  },
];
      ...
      <main className="max-w-4xl mx-auto px-4 py-10 space-y-8">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
            TranspaChain is a transparent charity platform on Ethereum where every donation is escrowed,
            every release is voted on by donors, and every transaction is verifiable on-chain.
          </p>
        </motion.div>
        ...
        <GlassPanel className="p-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            directly to an org wallet, donations lock in a smart-contract escrow vault. Organizations
            earn trust by submitting milestone proof; donors retain control through decentralized governance.
            Failed campaigns trigger refund eligibility — accountability built into the protocol.
          </p>
        </GlassPanel>
