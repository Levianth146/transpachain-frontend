    ...
    <div className="space-y-3">
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-lg border border-slate-300 bg-white py-2 pl-8 pr-4 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-teal-500/40 dark:border-slate-700 dark:bg-white/5 dark:text-white dark:placeholder:text-white/40 dark:focus:ring-accent-shine/50"
        />
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2">
              ...
              <motion.button
                ...
                className={`rounded-full px-3 py-1 text-xs font-medium transition-all ${
                  active
                    ...
                    : "border border-slate-300 bg-white text-slate-700 hover:border-slate-400 hover:text-slate-900 dark:border-slate-700 dark:bg-transparent dark:text-white/70 dark:hover:border-slate-600 dark:hover:text-white"
                }`}
              >
                {cat}
              </motion.button>
        ...
        <select
          ...
          className="rounded-full border border-slate-300 bg-white px-3 py-1 text-xs font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-teal-500/40 dark:border-slate-700 dark:bg-white/5 dark:text-white/70 dark:focus:ring-accent-shine/50"
        >
          {STATUSES.map((s) => (
