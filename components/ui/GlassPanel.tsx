...
export function GlassPanel({
  ...
  const base =
    "rounded-2xl border border-slate-200 bg-white/90 text-slate-900 shadow-lg shadow-slate-200/40 dark:border-white/10 dark:bg-white/[0.04] dark:text-white dark:shadow-black/20";
  const holo =
