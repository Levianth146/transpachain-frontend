...
export const IMPACT_NFT_ABI = [
  ...
  { name: "getTierMetadataCID", type: "function", stateMutability: "view", inputs: [{ name: "tier", type: "uint8" }], outputs: [{ name: "", type: "string" }] },
  { name: "setTierMetadataCID", type: "function", stateMutability: "nonpayable", inputs: [{ name: "tier", type: "uint8" }, { name: "cid", type: "string" }], outputs: [] },
